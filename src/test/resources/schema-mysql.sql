...
CREATE TABLE `work_calendar` (
  ...
  `description` varchar(256) COLLATE utf8_slovenian_ci DEFAULT NULL,
  `workdays` longtext COLLATE utf8_slovenian_ci,
  `year` int NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `workweek` (
  `id` int NOT NULL AUTO_INCREMENT,
  `description` varchar(256) COLLATE utf8_slovenian_ci NOT NULL,
