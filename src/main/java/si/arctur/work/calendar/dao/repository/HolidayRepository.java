...
public interface HolidayRepository extends JpaRepository<HolidayEntity, Long> {
    ...
    HolidayEntity getHolidayEntityByIdAndWorkCalendarId(@Param("id") Long id, @Param("calendarId") Long calendarId);
    ...
    Collection<HolidayEntity> getHolidayEntities(Long calendarId, LocalDate date, String name, Boolean isWorkFree);
